...
class Project(models.Model):
    ...
    users = models.ManyToManyField(PortalUser, null=True, blank=True)
...
class ToDo(models.Model):
    ...
    created_by = models.ForeignKey(PortalUser, on_delete=models.CASCADE, related_name='portal_users', blank=True, null=True)
